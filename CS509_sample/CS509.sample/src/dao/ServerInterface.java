...
public enum ServerInterface {
	...
	public String getAirplans (String teamName) {
		...
		try {
			 ...
			 * Create an HTTP connection to the server for a GET 
			 */
			url = new URL(mUrlBase + QueryFactory.getAirplans(teamName));
			connection = (HttpURLConnection) url.openConnection();
			connection.setRequestMethod("GET");
			connection.setRequestProperty("User-Agent", teamName);
		...
		xmlAirplans = result.toString();
		System.out.println(xmlAirplans);
		//airports = DaoAirport.addAll(xmlAirports);
		return xmlAirplans;
		
	}
	
	public ArrayList<Depart> departPlans (String teamName, String code, String time) {
       ArrayList<Depart> departLists = new ArrayList<>();
		...
		try {
			 ...
			 * Create an HTTP connection to the server for a GET 
			 */
			url = new URL(mUrlBase + QueryFactory.departAirplans(teamName, code, time));
			connection = (HttpURLConnection) url.openConnection();
			connection.setRequestMethod("GET");
			connection.setRequestProperty("User-Agent", teamName);
		...
		xmlAirplans = result.toString();
		System.out.println(xmlAirplans);
		// DaoAirport.addAll(xmlAirplans);
		departLists = departDom.addAll(xmlAirplans);
		return departLists;	
	}
